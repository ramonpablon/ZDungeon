...
public class GameManager : MonoBehaviour {
    ...
    void Update () {
        ...
        P2.GetComponent<PlayerPhisics>().rend.material.SetFloat("Vector1_93698D3F", P2.GetComponent<InputManager>().damage);

        foreach (Transform childs in P2.transform.GetChild(0))
        {
            childs.GetComponent<Renderer>().material.SetFloat("Vector1_93698D3F", P2.GetComponent<InputManager>().damage);
        }
    }
}
