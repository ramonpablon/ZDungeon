...
public class InputManager_CPU : PlayerPhisics_CPU {

    #region Click Event
    [Space]
    [Header("----CPU JOYSTICK----new")]
    ...
    void Update () {
        ...
        if (Defend && canBlock && !isDashing )
        {
            ...
            #region Parry
        if (Defend && canParry && !parryCollider.activeSelf)
        {
